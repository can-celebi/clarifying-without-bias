window.SITE_DATA = {
  "meta": {
    "generatedAt": "2026-06-01 17:03 CEST",
    "preliminary": true,
  ...
  "phaseB": {
    "conditions": ["A — P-all (nano)", "P-all + corrector (nano)", "Reasoning low (nano)", "Reasoning medium (nano)", "Reasoning high (nano)", "gpt-5.4-mini"],
    "byCondition": [
      {
        "scenario": "mirror-start",
        "label": "A — P-all (nano)",
